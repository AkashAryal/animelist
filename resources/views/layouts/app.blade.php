            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <ul class="navbar-nav mr-auto">
                          <li class="nav-item">
                            <a class="nav-link" href="{{url('/myList')}}" style="color: white;">My List</a>
                          </li>
                        </ul>
                        ...
                        <ul class="navbar-nav mr-auto">
                          <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right formcard" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item logout-hover" href="{{ route('logout') }}"
